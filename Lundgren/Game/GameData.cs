...
namespace Lundgren.Game
{
    public static class GameData
    {
        ...
        private static readonly string[] ExternalCharIds =
        {
            "Captain Falcon",
            "Donkey Kong",
            "Fox",
        ...
        private static readonly string[] InteralCharIds =
        {
            "Donkey Kong",
            "Kirby",
            "Bowser",
        ...
        public static string ExternalChar(byte charNum)
        {
            if (charNum == 99)
                return "None";
            return ExternalCharIds[charNum];
        }

        public static string Action(uint state)
        {
            return state < 382 ? ((Animation)state).ToString() : "None";
        }
    }
}